...
public class DbConnection : IDbConnection
{
    ...
    private string _connectionId = "MongoDB"; // referencja do json'a
    ...
    {
        _config = config;
        Client = new MongoClient(_config.GetConnectionString(_connectionId)); // utworzony nowy klient
        DbName = _config["DatabaseName"]; // Nazwa DB ustawiona w appsettings
